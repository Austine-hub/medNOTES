...
const OBGYN: React.FC<PharmacologyProps> = ({ diagrams = pharmaDiagrams }) => {
  ...
  return (
    <div className={styles.pharmacologyWrap}>
      ...
      {/* Title + intro */}
      <h1 className={styles.title}>OBGYN</h1>
      <p className={styles.lead}>
        Browse our catalogue of free Obstetrics and Gynaecology diagrams. Click a card
      ...
      <div className={styles.searchContainer}>
        <label htmlFor="pharma-search" className={styles.hiddenLabel}>
          Search OBGYN diagrams
        </label>
        <input
          id="pharma-search"
          type="search"
          placeholder="Search OBGYN..."
          value={searchQuery}
          onChange={(e) => {
      ...
      {pageItems.length > 0 ? (
        ...
        <p className={styles.noResults}>
          NoOBGYN diagrams found. Try a different search term.
        </p>
      )}
