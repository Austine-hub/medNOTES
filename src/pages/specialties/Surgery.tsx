...
const Surgery: React.FC<PharmacologyProps> = ({ diagrams = pharmaDiagrams }) => {
  ...
  return (
    <div className={styles.pharmacologyWrap}>
      ...
      {/* Title + intro */}
      <h1 className={styles.title}>Surgery</h1>
      <p className={styles.lead}>
        Browse our catalogue of free Surgery diagrams. Click a card
      ...
      {pageItems.length > 0 ? (
        ...
        <p className={styles.noResults}>
          No Surgery diagrams found. Try a different search term.
        </p>
      )}
